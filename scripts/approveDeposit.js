...
const ABI = require('../artifacts/contracts/IND_ETH.sol/IND_ETH.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("IND_ETH");
  const nft = await NFT.attach('0x93b997E3669CAADf955e68c6c97E49E13c80b444');
  ...
  console.log("INDNFT wallet balance", wallet.address, "is: ", balance.toString());
}
